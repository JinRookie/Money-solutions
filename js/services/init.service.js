 ...
 * Note: Includes archived/inactive wallets. Even if a bank account is closed (archived), 
 * the funds historically held in it still contributed to the user's overall net worth.
 * @returns {number}
 */
 ...
 * Design Choice: Transfers are explicitly excluded from daily flow calculations. 
 * Transfers represent internal money movement (shuffling between own accounts), 
 * not new income or actual expenses leaving the user's ecosystem.
